...
enum {
  ...
  sym_dataModule = 86,
  sym_settings = 87,
  sym_presetDefinition = 88,
  sym__block = 89,
  sym_statement = 90,
  sym_property = 91,
  sym__value = 92,
  sym_classDefinition = 93,
  sym_className = 94,
  sym_number = 95,
  aux_sym_source_file_repeat1 = 96,
  aux_sym__block_repeat1 = 97,
};
...
static bool ts_lex(TSLexer *lexer, TSStateId state) {
  ...
  switch (state) {
    ...
    case 1:
      ...
      if (('F' <= lookahead && lookahead <= 'Z')) ADVANCE(1512);
    ...
    case 889:
      ...
      if (('0' <= lookahead && lookahead <= '9') ||
          ('A' <= lookahead && lookahead <= 'Z') ||
          lookahead == '_' ||
          ('a' <= lookahead && lookahead <= 'y')) ADVANCE(890);
      END_STATE();
    case 890:
      ACCEPT_TOKEN(aux_sym_presetDefinition_token1);
      if (('0' <= lookahead && lookahead <= '9') ||
    ...
    case 892:
      ...
      if (lookahead == ' ' ||
          ('0' <= lookahead && lookahead <= '9') ||
          ('A' <= lookahead && lookahead <= 'z')) ADVANCE(1512);
      if (lookahead != 0 &&
          lookahead != '\n') ADVANCE(1543);
      END_STATE();
    case 893:
    ...
    case 1103:
      ...
      if (lookahead == ' ' ||
          ('0' <= lookahead && lookahead <= '9') ||
          ('B' <= lookahead && lookahead <= 'z')) ADVANCE(1512);
      if (lookahead != 0 &&
          lookahead != '\n') ADVANCE(1543);
      END_STATE();
    case 1104:
    ...
    case 1511:
      ACCEPT_TOKEN(sym_string);
      if (lookahead == '.') ADVANCE(1535);
      if (lookahead == 'z') ADVANCE(1297);
      if (lookahead == ' ' ||
          ('0' <= lookahead && lookahead <= '9') ||
          ('A' <= lookahead && lookahead <= 'y')) ADVANCE(1512);
      if (lookahead != 0 &&
          lookahead != '\n') ADVANCE(1543);
      END_STATE();
    case 1512:
...
static const TSLexMode ts_lex_modes[STATE_COUNT] = {
  ...
  [1] = {.lex_state = 446, .external_lex_state = 2},
  [2] = {.lex_state = 1, .external_lex_state = 2},
  [3] = {.lex_state = 417, .external_lex_state = 2},
  [4] = {.lex_state = 446, .external_lex_state = 2},
  [5] = {.lex_state = 446, .external_lex_state = 2},
  [6] = {.lex_state = 446, .external_lex_state = 2},
  [7] = {.lex_state = 446, .external_lex_state = 2},
  [8] = {.lex_state = 443, .external_lex_state = 2},
  [9] = {.lex_state = 443, .external_lex_state = 2},
  [10] = {.lex_state = 443, .external_lex_state = 2},
  [11] = {.lex_state = 446, .external_lex_state = 2},
  [12] = {.lex_state = 443, .external_lex_state = 2},
  [13] = {.lex_state = 443, .external_lex_state = 3},
  [14] = {.lex_state = 446, .external_lex_state = 2},
  [15] = {.lex_state = 446, .external_lex_state = 2},
  [16] = {.lex_state = 443, .external_lex_state = 3},
  [17] = {.lex_state = 446, .external_lex_state = 2},
  [18] = {.lex_state = 443, .external_lex_state = 3},
  [19] = {.lex_state = 443, .external_lex_state = 3},
  [20] = {.lex_state = 443, .external_lex_state = 3},
  [21] = {.lex_state = 443, .external_lex_state = 3},
  [22] = {.lex_state = 443, .external_lex_state = 3},
  [23] = {.lex_state = 417, .external_lex_state = 2},
...
static const uint16_t ts_parse_table[LARGE_STATE_COUNT][SYMBOL_COUNT] = {
  ...
  [3] = {
    [sym_classDefinition] = STATE(15),
    [sym_className] = STATE(25),
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [28] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_source_file_repeat1, 2), SHIFT_REPEAT(32),
  ...
  [39] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_dataModule, 3),
  [41] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_dataModule, 3),
  ...
  [49] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_includeFile, 3),
  [51] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_includeFile, 3),
  [53] = {.entry = {.count = 1, .reusable = true}}, SHIFT(17),
  [55] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_settings, 3),
  [57] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_settings, 3),
  [59] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_presetDefinition, 3, .production_id = 1),
  [61] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_presetDefinition, 3, .production_id = 1),
  ...
  [69] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__block_repeat1, 2), SHIFT_REPEAT(28),
  [72] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__block_repeat1, 2),
  [74] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_statement, 3),
  [76] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_number, 1),
  [78] = {.entry = {.count = 1, .reusable = true}}, SHIFT(11),
  [80] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_className, 1),
  [82] = {.entry = {.count = 1, .reusable = true}}, SHIFT(12),
  [84] = {.entry = {.count = 1, .reusable = true}}, SHIFT(23),
  [86] = {.entry = {.count = 1, .reusable = true}}, SHIFT(2),
  [88] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_property, 1),
