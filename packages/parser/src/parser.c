...
static bool ts_lex(TSLexer *lexer, TSStateId state) {
  ...
  switch (state) {
    ...
    case 1:
      ...
      if (('F' <= lookahead && lookahead <= 'Z')) ADVANCE(1559);
    ...
    case 468:
      ...
      if (('0' <= lookahead && lookahead <= '9') ||
          ...
          lookahead == '_' ||
          ('b' <= lookahead && lookahead <= 'z')) ADVANCE(926);
      END_STATE();
    case 469:
      ACCEPT_TOKEN(aux_sym_presetDefinition_token1);
    ...
    case 925:
      ...
      if (('0' <= lookahead && lookahead <= '9') ||
          ('A' <= lookahead && lookahead <= 'Z') ||
          lookahead == '_' ||
          ('a' <= lookahead && lookahead <= 'y')) ADVANCE(926);
      END_STATE();
    case 926:
      ACCEPT_TOKEN(aux_sym_presetDefinition_token1);
      if (('0' <= lookahead && lookahead <= '9') ||
    ...
    case 1142:
      ...
      if (lookahead == ' ' ||
          ('0' <= lookahead && lookahead <= '9') ||
          ('B' <= lookahead && lookahead <= 'z')) ADVANCE(1559);
      if (lookahead != 0 &&
          lookahead != '\n') ADVANCE(1569);
      END_STATE();
    case 1143:
    ...
    case 1558:
      ...
      if (lookahead == ' ' ||
          ('0' <= lookahead && lookahead <= '9') ||
          ('A' <= lookahead && lookahead <= 'y')) ADVANCE(1559);
      if (lookahead != 0 &&
          lookahead != '\n') ADVANCE(1569);
      END_STATE();
    case 1559:
    ...
    case 1568:
      ACCEPT_TOKEN(sym_string);
      if (('A' <= lookahead && lookahead <= 'Z')) ADVANCE(1559);
      if (lookahead != 0 &&
          lookahead != '\n') ADVANCE(1569);
      END_STATE();
    case 1569:
...
static const TSLexMode ts_lex_modes[STATE_COUNT] = {
  ...
  [1] = {.lex_state = 461, .external_lex_state = 2},
  ...
  [6] = {.lex_state = 461, .external_lex_state = 3},
  [7] = {.lex_state = 461, .external_lex_state = 3},
